    ...
    >
      <div className="max-w-screen-lg mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-4">
        ...
        <div className="flex flex-col justify-center order-1 md:order-1">
          <h2 className="text-4xl sm:text-4xl md:text-4xl font-bold text-white mt-8 md:mt-0 mb-4 sm:mb-6">
            Software Engineer | <br /> Full-Stack JavaScript Developer
          </h2>
          <p className="text-gray-400 text-base sm:text-lg md:text-lg mb-6 max-w-md">
            ...
            TypeScript, Tailwind CSS, Bootstrap, Material UI, and backend tools
            like Express.js & MongoDB. I also ensure apps are reliable through
            manual testing.
          </p>
